...
export function LocationFinder() {
  ...
  return (
    ...
    >
      <button
        type="button"
        className="inline-flex h-9 w-9 shrink-0 items-center justify-center overflow-hidden rounded-full border border-slate-200 bg-white/70 p-1.5 text-slate-600 hover:border-brand-500 hover:text-brand-700 transition-colors sm:h-10 sm:w-10"
        aria-label="Find us / View address"
      >
        <svg
          width="24"
          height="24"
          className="block h-5 w-5 max-h-full max-w-full sm:h-6 sm:w-6"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
          aria-hidden
