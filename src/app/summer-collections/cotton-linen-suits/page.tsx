...
export default function CottonLinenSuitsPage() {
  const products = catalog
    .filter((p) => p.subcategory === "Cotton/Linen Suits")
  ...
  return (
    <div className="space-y-8">
      <header className="space-y-2">
        ...
        <h1 className="section-title">Cotton/Linen Suits</h1>
        <p className="section-subtitle max-w-2xl">
          Soft, breathable cotton-linen blends made for all-day comfort in warm
          weather. Available in multiple summer-perfect colors.
        </p>
      </header>
