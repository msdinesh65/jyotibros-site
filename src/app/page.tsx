      ...
      <section className="relative overflow-hidden rounded-3xl bg-slate-900/5">
        <div className="relative h-[340px] sm:h-[420px] lg:h-[500px]">
          ...
          <a
            ...
            className="absolute top-4 right-4 z-10 inline-flex items-center gap-2 rounded-xl bg-[#25D366] px-4 py-2.5 text-sm font-semibold text-white shadow-lg hover:bg-[#20BD5A] transition-colors"
          ...
          <button
            ...
            className="absolute left-3 top-1/2 -translate-y-1/2 rounded-full bg-black/30 text-white p-2 text-sm hover:bg-black/45"
          ...
          <button
            type="button"
            onClick={goToNext}
            className="absolute right-3 top-1/2 -translate-y-1/2 rounded-full bg-black/30 text-white p-2 text-sm hover:bg-black/45"
